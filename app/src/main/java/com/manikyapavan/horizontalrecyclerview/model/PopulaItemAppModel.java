package com.manikyapavan.horizontalrecyclerview.model;

public class PopulaItemAppModel {
    private int itemImage;
    private String itemHeader;
    private String itemSubHeader;
    private String itemNumber;

    public PopulaItemAppModel(String itemHeader, String itemSubHeader, int itemImage, String itemNumber) {
